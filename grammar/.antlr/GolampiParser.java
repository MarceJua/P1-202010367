...
public class GolampiParser extends Parser {
	...
	public static final int
		RULE_file = 0, RULE_instruction = 1, RULE_printStmt = 2, RULE_varDecl = 3, 
		RULE_assignStmt = 4, RULE_expressionList = 5, RULE_expression = 6, RULE_type = 7, 
		RULE_stmtTerminator = 8;
	...
	public final FileContext file() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 548864L) != 0)) {
				{
				{
				setState(18);
				instruction();
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			setState(83);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 199680L) != 0)) ) {
	...
	public final StmtTerminatorContext stmtTerminator() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_stmtTerminator);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(85);
			_la = _input.LA(1);
			if ( !(((((_la - -1)) & ~0x3f) == 0 && ((1L << (_la - -1)) & 33562625L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
